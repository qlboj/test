...
$(function(){
  $(".nav").slide({type:"menu", titCell:".title", targetCell:".list", defaultPlay:false,effect:"slideDown",delayTime:310,triggerTime:0,returnDefault:true,titOnClassName:"on_on"});

  $("#bch_type .content li:last-child").css("background","none");

  $("#bch_type .content li").hover(function(e) {
  ...
  $(".nav ul li:last-child").addClass("no_bg");

  $("#s_mian_box .f2 .md").click(function(){
...
$(function(){
  $(".nav .title a").each(function(){
    ...
    if($this[0].href==String(window.location)){
      $this.parent(".title").addClass("on");  //on表示被选中效果的类名
      $this.parent().parent(".title").addClass("on")
    }
  });
})
